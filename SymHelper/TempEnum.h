...
enum class ItemStackRequestActionType : char {
    ...
    Consume                                  = 5,
    Create                                   = 6,
    ScreenLabTableCombine                    = 7,
    ScreenBeaconPayment                      = 8,
    ScreenHUDMineBlock                       = 9,
    CraftRecipe                              = 10,
    CraftRecipeAuto                          = 11,
    CraftCreative                            = 12,
    ...
    CraftLoom                                = 15,
    CraftNonImplemented_DEPRECATEDASKTYLAING = 16,
    CraftResults_DEPRECATEDASKTYLAING        = 17,
};
...
enum class ActorType_ : unsigned short {
