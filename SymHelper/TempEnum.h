...
enum ContainerCollectionNameMap : char {
    beacon_payment_items                = 8,
    anvil_input_items                   = 0,
    anvil_material_items                = 1,
    anvil_result_items                  = 2,
    smithing_table_input_items          = 3,
    smithing_table_material_items       = 4,
    smithing_table_result_items         = 5,
    armor_items                         = 6,
    container_items                     = 7,
    brewing_input_item                  = 9,
    brewing_result_items                = 10,
    brewing_fuel_item                   = 11,
    combined_hotbar_and_inventory_items = 12,
    crafting_input_items                = 13,
    crafting_output_items               = 14,
    ...
    recipe_equipment                    = 20,
    enchanting_input_items              = 21,
    enchanting_lapis_items              = 22,
    furnace_fuel_items                  = 23,
    furnace_ingredient_items            = 24,
    furnace_output_items                = 25,
    horse_equip_items                   = 26,
    hotbar_items                        = 27,
    inventory_items                     = 28,
    trade_ingredient1_items             = 30,
    trade_ingredient2_items             = 31,
    trade_result_item                   = 32,
    container_items                     = 29,
    offhand_items                       = 33,
    compcreate_input                    = 34,
    compcreate_output                   = 35,
    elemconstruct_output                = 36,
    matreduce_input                     = 37,
    matreduce_output                    = 38,
    labtable_input                      = 39,
    loom_input_items                    = 40,
    loom_dye_items                      = 41,
    loom_material_items                 = 42,
    loom_result_items                   = 43,
    furnace_ingredient_items            = 44,
    furnace_ingredient_items            = 45,
    trade2_ingredient1_item             = 46,
    trade2_ingredient2_item             = 47,
    trade2_result_item                  = 48,
    grindstone_input_items              = 49,
    grindstone_additional_items         = 50,
    grindstone_result_items             = 51,
    stonecutter_input_items             = 52,
    stonecutter_result_items            = 53,
    cartography_input_items             = 54,
    cartography_additional_items        = 55,
    cartography_result_items            = 56,
    container_items                     = 57,
    cursor_items                        = 58,
    creative_output_items               = 59,
};
